		...
		*/
		virtual bool SetNonlinearParameter(CVector& vParam)
		{
			...
			if(iLinSize > 0)
			{
				...
				mExponent.SetLinearParameter(temp);
			}
			...
			if(iNonlinSize > 0)
			{
				...
				mExponent.SetNonlinearParameter(temp);
			}
		...
		*/
		virtual void SetNonlinearCovarMatrix(CMatrix& mCovar)
		{
			...
			if(iLinSize > 0)
			{
				...
				mExponent.SetLinearCovarMatrix(temp);
			}
			...
			if(iNonlinSize > 0)
			{
				...
				mExponent.SetNonlinearCovarMatrix(temp);
			}
		}
		...
		*/
		virtual void SetNonlinearCorrelMatrix(CMatrix& mCorrel)
		{
			...
			if(iLinSize > 0)
			{
				...
				mExponent.SetLinearCorrelMatrix(temp);
			}
			...
			if(iNonlinSize > 0)
			{
				...
				mExponent.SetNonlinearCorrelMatrix(temp);
			}
		}
		...
		*/
		virtual void SetNonlinearError(CVector& vError)
		{
			...
			if(iNonlinSize > 0)
			{
				...
				mExponent.SetNonlinearError(temp);
			}
		}
