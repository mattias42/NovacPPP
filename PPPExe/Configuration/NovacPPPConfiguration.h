	...
	public:
		...
		*/
		...
		/** Retrieves the CFitWindow that is valid for the given instrument and
			...
			@return 0 if successful otherwise non-zero		
		*/
		int GetFitWindow(const novac::CString &serial, int channel, const novac::CDateTime &dateAndTime, Evaluation::CFitWindow &window, const novac::CString *fitWindowName = NULL) const;
