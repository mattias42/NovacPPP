...
RETURN_CODE CSTDFile::ReadSpectrum(CSpectrum &spec, const novac::CString &fileName){
	...
	if(tmpInt > 31){
		spec.m_info.m_startTime.year	= spec.m_info.m_stopTime.year	= (tmpInt < 1900) ? tmpInt + 2000 : tmpInt;
		spec.m_info.m_startTime.month	= spec.m_info.m_stopTime.month	= tmpInt2;
		spec.m_info.m_startTime.day		= spec.m_info.m_stopTime.day	= tmpInt3;
	}else{
		spec.m_info.m_startTime.year	= spec.m_info.m_stopTime.year	= (tmpInt3 < 1900) ? tmpInt3 + 2000 : tmpInt3;
		spec.m_info.m_startTime.month	= spec.m_info.m_stopTime.month	= tmpInt2;
		spec.m_info.m_startTime.day		= spec.m_info.m_stopTime.day	= tmpInt;
	}
