...
RETURN_CODE CSTDFile::ReadSpectrum(CSpectrum &spec, const novac::CString &fileName) {
	...
	if (tmpInt > 31) {
		...
		spec.m_info.m_stopTime.year = (unsigned short)((tmpInt < 1900) ? tmpInt + 2000 : tmpInt);
		spec.m_info.m_startTime.month = (unsigned char)(tmpInt2);
		spec.m_info.m_stopTime.month = (unsigned char)(tmpInt2);
		spec.m_info.m_startTime.day = (unsigned char)(tmpInt3);
		spec.m_info.m_stopTime.day = (unsigned char)(tmpInt3);
	}
	else {
		spec.m_info.m_startTime.year = (unsigned short)((tmpInt3 < 1900) ? tmpInt3 + 2000 : tmpInt3);
		spec.m_info.m_stopTime.year = (unsigned short)((tmpInt3 < 1900) ? tmpInt3 + 2000 : tmpInt3);
		spec.m_info.m_startTime.month = (unsigned char)(tmpInt2);
		spec.m_info.m_stopTime.month = (unsigned char)(tmpInt2);
		spec.m_info.m_startTime.day = (unsigned char)(tmpInt);
		spec.m_info.m_stopTime.day = (unsigned char)(tmpInt);
	}
